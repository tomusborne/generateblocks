...
export default applyFilters( 'generateblocks.editor.looper.query-parameters', [
	...
	},
	{
		...
		description: __( 'Show posts from taxonomies. Search by name or ID.', 'generateblocks' ),
	...
	},
	{
		...
		description: __( 'Exclude posts from taxonomies. Search by name or ID.', 'generateblocks' ),
		group: __( 'Taxonomy', 'generateblocks' ),
		isRepeatable: true,
		repeatableDefaultValue: { taxonomy: '', terms: [], rest: '', includeChildren: true },
	},
